...
$conc=mysqli_query($con,"select * from register where email='$session_id'");
 ...
 $data=mysqli_query($con,"SELECT bank_detail.*, buyer.* from bank_detail LEFT JOIN buyer ON bank_detail.tid = buyer.code where buyer.type = 0 and buyer.coin_type = 1 and buyer.status='' and bank_detail.addvert = 'addver'  and buyer.email !='$session_id'");
 $data1=mysqli_query($con,"SELECT bank_detail.*, buyer.* from bank_detail LEFT JOIN buyer ON bank_detail.tid = buyer.code where buyer.type = 1 and buyer.coin_type = 1 and buyer.status='' and bank_detail.addvert = 'addver'  and buyer.email !='$session_id'");
...
$addfetch=mysqli_fetch_array($btcadd);
 $btc_buy=$addfetch['eth_buy'];
 $btc_sell=$addfetch['eth_sell'];
 $btc_buysd=$addfetch['myr_eth_buy'];
  $btc_buyssd=$addfetch['myr_eth_sell'];

$finalbtcBuy=$btc+$btc_buy;
$finalbtcSell=$btc+$btc_sell;

$finalMYRBuy=$eth+$btc_buysd;
$finalMYRSell=$eth+$btc_buyssd;
...
">
        <?php if($state=='INR') { ?>
                ...
                <?php } ?>
                <br>
                <a class="btn btn-success" href="buy.html?ccoin=ETH" style="
...
">
               ...
               <?php if($state=='INR') { ?>
                ...
                <?php } ?>
                <br>
                <a class="btn btn-danger" href="buy.html?ccoin=ETH" style="
    padding: 10px 26px 10px 26px;
">Sell Now</a>
            </div>
            </div>
...
<h3>LIST OF SELLERS</h3>
    ...
    <ul>
        ...
        ?>
        <li class="offer"><div class="offer-wrapper sell-offer null offer-345601"><div class="row"><div class="col-xs-12 col-sm-9 text-left"><a class="offer-body-meta" href="#"><div class="offer-body"><strong class="offer-price text-success"><span><?php echo $fetch_data['amount']; ?></span><!-- react-text: 688 -->/<!-- /react-text --><span class="text-btc-color">ETH</span></strong><span> via </span><span><span><?php echo $fetch_data['bankname']; ?></span><span><!-- react-text: 694 --> <!-- /react-text --><!-- react-text: 695 -->IMPS/RTGS/NEFT Bank Transfer<!-- /react-text --></span></span></div><div class="offer-meta"> <!-- react-text: 698 --><!-- /react-text --><!-- react-text: 699 --> <!-- /react-text --> <!-- react-text: 702 --> <!-- /react-text --></strong></div></a><div class="offer-meta"><div class="offer-author"><a href=#"><strong class="offer-item-username"><span class="text-gray icon-globe-new"></span><span><?php echo $fetch_data['holdername']; ?></span></strong></a><!-- react-text: 710 --> <!-- /react-text --><em class="speed-badge badge badge-success">quick seller</em></div></div></div><div class="col-sm-3 text-right hidden-xs"><a class="btn btn-default" href="btcbby.html?aa=<?php echo $fetch_data['code'];  ?>&coin=1">Buy</a></div></div></div></li>
        <?php
                }
        ?>
    ...
    <ul>
        ...
        ?>
        <li class="offer"><div class="offer-wrapper sell-offer null offer-345601"><div class="row"><div class="col-xs-12 col-sm-9 text-left"><a class="offer-body-meta" href="#"><div class="offer-body"><strong class="offer-price text-success"><span><?php echo $fetch_data1['amount']; ?> </span><!-- react-text: 688 -->/<!-- /react-text --><span class="text-btc-color">ETH</span></strong><span> via </span><span><span><?php echo $fetch_data1['bankname']; ?></span><span><!-- react-text: 694 --> <!-- /react-text --><!-- react-text: 695 -->IMPS/RTGS/NEFT Bank Transfer<!-- /react-text --></span></span></div><div class="offer-meta"><!-- react-text: 698 --><!-- /react-text --><!-- react-text: 699 --> <!-- /react-text --><strong> <!-- react-text: 702 --> <!-- /react-text --></strong></div></a><div class="offer-meta"><div class="offer-author"><a href="/in/profile/ashuvicky"><strong class="offer-item-username"><span class="text-gray icon-globe-new"></span><span><?php echo $fetch_data1['holdername']; ?></span></strong></a><!-- react-text: 710 --> <!-- /react-text --><em class="speed-badge badge badge-success">quick buyer</em></div></div></div><div class="col-sm-3 text-right hidden-xs"><a class="btn btn-default" href="btcsell.html?bb=<?php echo $fetch_data1['code']; ?>&coin=1">Sell</a></div></div></div></li>
         <?php
                } 
         ?>
